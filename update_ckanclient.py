...
class CkanPost(ckanclient.CkanClient):
    ...
    def test_post_package_resource(self):
        ...
        package_entity = {
            ...
            'url': ("https://commondatastorage.googleapis.comckannet-storage"
                    "/2011-11-24T112025/AfTerFibre_21nov2011.csv",
            'download_url': ("https://commondatastorage.googleapis.comckannet-storage"
                    "/2011-11-24T112025/AfTerFibre_21nov2011.csv",
            'tags': "Senegal ANSD",
            "groups" :['country-sn'],
